...
<body>
    ...
    <h1>CLASS CONTROLLER</h1>
        <form action="elaboracontroller.php">
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <label for="name_space">Namespace</label>
                        <input type="text" class="form-control" id="name_space" name="name_space" placeholder="esempio App\Controller" value="App\Controller" required autofocus>
                    </div>
                </div>
            </div>
            <div class="row">
